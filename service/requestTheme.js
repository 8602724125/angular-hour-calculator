...
const rejectThemeMail = async function (user) {
  ...
  const mailOptions = {
    ...
    html: `<div class="container">
      <p>Hello ${user.name},</p>
        <div class="m-5">
          </p>You have successfully added a request for change the theme of CIS Hour Website.</p>
          <p>
...
module.exports.rejectThemeMail = rejectThemeMail;
